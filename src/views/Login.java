...
public class Login extends JFrame {
	...
	public Login() {
		...
		labelTitulo.setBounds(65, 149, 300, 26);
		...
		//se pasa this para dar al controlador de usuarios acceso a la instancia actual 
		//de la ventana de interfaz de usuario en la que se encuentra el botón, lo que le permite 
		//interactuar con esa ventana según sea necesario.
