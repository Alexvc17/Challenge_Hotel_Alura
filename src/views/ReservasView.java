...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {	
		if(txtFechaE.getDate() != null && txtFechaS.getDate()!=null && !txtValor.equals("") && !txtFormaPago.equals(" ")) {
			
			LocalDate fechaE = LocalDate.parse(((JTextField)txtFechaE.getDateEditor().getUiComponent()).getText());
			LocalDate fechaS = LocalDate.parse(((JTextField)txtFechaS.getDateEditor().getUiComponent()).getText());
			
			Reserva nuevaReserva = new Reserva(fechaE,fechaS, txtValor.getText(),txtFormaPago.getSelectedItem().toString());
			//le enviamos los datos al metodo guardar
